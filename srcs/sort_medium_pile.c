...
/*   Updated: 2023/03/08 15:05:40 by abonnefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_medium_pile_a(t_pile *pile)
{
	...
	while (pile->pile_a)
	{
		...
		// if(data_first == -1 && data_last == -1)
		// 	ft_next_chunk(pile); // NEW

		// // if (ft_data_index_first(pile) == -1 && ft_data_index_first(pile) == -1) // NEW
		// // 	ft_next_chunk(pile); // NEW
